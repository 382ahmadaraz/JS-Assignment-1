...
document.getElementById("alertName").onclick = function () {
    ...
    alert(myName);
    document.getElementById("output-box").innerHTML = myName;
    document.getElementById("input-box").innerHTML = myName;
}
document.getElementById('alertNumber').onclick = function () {
    let rollNo = "175991";
    alert(rollNo)
    document.getElementById('input-box').innerHTML = rollNo;
    document.getElementById('output-box').innerHTML = rollNo;
}
